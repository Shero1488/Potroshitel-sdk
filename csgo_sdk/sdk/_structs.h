...
public:
	...
	__forceinline float get_body_yaw_modifier() const {
		auto walk_speed = m_speed_as_portion_of_walk_speed;
		math::clamp(walk_speed, 0.f, 1.f);
		...
		if (m_duck_amount > 0.f) {
			auto crouch_walk_speed = m_speed_as_portion_of_crouch_speed;
			math::clamp(crouch_walk_speed, 0.f, 1.f);
