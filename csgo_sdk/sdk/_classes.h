...
public:
	...
	template< typename T >
	__forceinline T as( ) { return ( T )this; }
...
public:
	...
	__forceinline bool compute_hitbox_surrounding_box( vec3_t* mins, vec3_t* maxs ) {
		using fn = bool(__thiscall*)(void*, vec3_t*, vec3_t*);
		static const auto compute_hitbox_surrounding_box_sig = SIG("client.dll", "E9 ? ? ? ? 32 C0 5D").rel32( 0x1 );

		return compute_hitbox_surrounding_box_sig.cast<fn>( )( this, mins, maxs );
